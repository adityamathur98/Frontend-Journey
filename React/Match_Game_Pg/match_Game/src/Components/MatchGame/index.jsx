...
const MatchGame = () => {
  ...
  const [imgUrl, setImgUrl] = useState(imagesList[0].imageUrl);
  ...
  const playAgain = () => {
    ...
    setImgUrl(imagesList[0].imageUrl);
    intervalRef.current = setInterval(() => {
      setTime((prevTime) => prevTime - 1);
    }, 1000);
  };
  ...
  const renderResultView = () => {
    return (
      <div className="flex flex-col items-center w-[480px] h-[600px] bg-[url('https://assets.ccbp.in/frontend/react-js/match-game-bg.png')] bg-cover">
        <img
          src="https://assets.ccbp.in/frontend/react-js/match-game-trophy.png"
          alt="trophy"
          className="w-[280px] h-[220px] nt-[180px]"
        />
        <p className="text-[#ffffff] text-[18px] m-0">Your Score</p>
        <p className="text-[#ffffff] text-[34px] m-[10px] mb-[25px]">{score}</p>
        <button
          type="button"
          className="w-[160px] p-[5px] border-none outline-none bg-[#cf60c8] rounded-[10px] text-[#ffffff] p-[10px] flex justify-center items-center"
          onClick={playAgain}>
          <img
  ...
  const renderMatchGameView = () => {
    ...
    return (
      <div className="flex flex-col items-center">
        <img src={imgUrl} alt="match" className="w-[500px] h-[300px]" />
        ...
        <ul className="flex items-center flex-wrap w-[500px] list-none p-0 ">
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex flex-col min-h-screen max-h-[100%] w-screen">
        <Navbar score={score} time={time} />
        <div className="w-[100vw] h-[100%] bg-[url('https://assets.ccbp.in/frontend/react-js/match-game-bg.png')] bg-cover flex flex-col items-center p-[40px]">
          {isGameInProgress ? renderMatchGameView() : renderResultView()}
        </div>
      </div>
    </div>
  );
